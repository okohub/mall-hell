...
- **v5.10** - Extra-time power-up, improved chase AI pathing around blockers, clear-LOS direct chase behavior, and tighter doorway collision margins to prevent enemy wall clipping
