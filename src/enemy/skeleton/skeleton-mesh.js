// ============================================
// SKELETON MESH - Pure Mesh Creation
// ============================================
// Stateless mesh creation for skeleton enemy
// Receives all dependencies as parameters

const SkeletonMesh = {
    /**
     * Create complete skeleton enemy with health bar
     * @param {THREE} THREE - Three.js library
     * @param {Object} config - Enemy type config
     * @returns {THREE.Group} Complete skeleton group with health bar
     */
    ...
    // ==========================================
    // HEALTH BAR - Regular Style
    // ==========================================

    /**
     * Create regular health bar
     * @private
     * @param {THREE} THREE - Three.js library
    ...
    /**
     * Update skeleton health bar display
    ...
    /**
     * Apply hit flash effect to skeleton
    ...
    applyHitFlash(enemyMesh, intensity) {
        ...
        if (body && body.material) {
            if (intensity > 0) {
                ...
                body.material.emissive.setHex(0xffffff); // White flash
