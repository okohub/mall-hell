...
// ============================================
// Pure UI functions for HUD, popups, and visual feedback.
// No game state dependencies - receives data as parameters.
...
const UI = {
    ...
    showHitMarker() {
        if (this.elements.hitMarker) {
            ...
            setTimeout(() => this.elements.hitMarker.classList.remove('show'), 150);
        }
    },
    ...
    updateCooldownIndicator(elapsed, cooldown) {
        ...
        if (this.elements.cooldownFill) {
            ...
            this.elements.cooldownFill.style.borderTopColor = progress >= 1 ? '#2ecc71' : '#e94560';
        }
    },
